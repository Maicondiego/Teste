...
<section class="view" id="tiktok">
  ...
  <div class="panel">
    ...
    <div id="tkActions" style="display:none;margin-top:18px;border-top:1px solid var(--line);padding-top:18px">
      ...
      <div class="warning">SIMULAÇÃO VISUAL — nenhuma conta real é acessada, invadida ou derrubada.</div>
...
<section class="view" id="terminal">
  ...
  <div class="sub">CONSOLE LOCAL // COMANDOS VISUAIS</div>
...
<div class="footer">MARCOLA // VISUAL SIMULATION</div>
</main>
</div>
</div>
</div>
...
async function visualAction(action){
  ...
  const steps = action === "INVADIR CONTA"
    ...
    : [
        ...
        "[SIM] Preparando requisição simulada...",
  ...
  out.innerHTML +=
    `\\n\\n<span class="ok">[DEMO] ${action} — SIMULAÇÃO CONCLUÍDA.</span>` +
    `\\n<span class="warning">Nenhuma ação real foi executada.</span>`;
}
